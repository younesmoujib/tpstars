package com.example.recyleview1.adapter;
...
import com.example.recyleview1.R;
...
public class StarAdapter extends RecyclerView.Adapter<StarAdapter.StarViewHolder> implements Filterable {
    ...
    public StarViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(this.context).inflate(R.layout.activity_item, viewGroup, false);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bar.setRating(((RatingBar) v.findViewById(R.id.star)).getRating());
    ...
    public class StarViewHolder extends RecyclerView.ViewHolder {
        ...
        public StarViewHolder(@NonNull View itemView) {
            super(itemView);
            idss = itemView.findViewById(R.id.id);
